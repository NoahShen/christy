...
import net.sf.christy.disco.impl.DiscoInfoFeatureServiceTracker;
import net.sf.christy.disco.impl.DiscoInfoIdentityServiceTracker;
import net.sf.christy.disco.impl.DiscoItemServiceTracker;
import net.sf.christy.disco.impl.DiscoManagerImpl;
import net.sf.christy.disco.parser.DiscoInfoExtensionParser;
import net.sf.christy.disco.parser.DiscoItemsExtensionParser;
