...
public interface UserPrivacyListDbHelper
{
	 ...
	 * @throws Exception
	 */
	public UserPrivacyList getActiveUserPrivacyList(String username) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void cancelActivePrivacyList(String username) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void setActivePrivacyList(String username, String privacyName) throws Exception;
