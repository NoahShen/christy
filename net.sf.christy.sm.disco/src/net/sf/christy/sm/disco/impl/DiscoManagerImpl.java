...
import net.sf.christy.sm.disco.DiscoInfoExtension;
import net.sf.christy.sm.disco.DiscoInfoFeature;
import net.sf.christy.sm.disco.DiscoInfoIdentity;
import net.sf.christy.sm.disco.DiscoItem;
import net.sf.christy.sm.disco.DiscoItemsExtension;
import net.sf.christy.sm.disco.DiscoManager;
